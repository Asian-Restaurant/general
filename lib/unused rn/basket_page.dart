...
//
//   const BasketPage({super.key, required this.cartData});
//
//   @override
...
//     // Save the cart state before navigating
//     _saveCart();
//
//     switch (page) {
//       case "Main Page":
...
//         ),
//         onPressed: () => _navigateTo(text), // Call the new method to navigate
//         child: Text(
//           text,
